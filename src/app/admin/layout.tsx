  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500 selection:text-black">
      ...
      <main className="md:ml-[80px] lg:ml-[280px] min-h-screen transition-all duration-300">
        ...
        <header className="sticky top-0 z-40 h-20 bg-zinc-950/40 backdrop-blur-3xl border-b border-white/5 px-6 flex items-center justify-between">
           <div className="flex items-center gap-4">
              <div className="md:hidden w-10 h-10 rounded-2xl bg-emerald-500/10 border border-emerald-500/10 flex items-center justify-center text-emerald-500 font-black shadow-[0_0_20px_rgba(16,185,129,0.1)]">
                C
              </div>
              <div className="hidden md:flex-1 max-w-sm relative group">
                 ...
                 <input 
                   type="text" 
                   placeholder="Search..."
                   className="w-full bg-white/[0.03] border border-white/5 rounded-2xl py-2.5 pl-12 pr-4 text-xs font-semibold placeholder:text-zinc-700 outline-none focus:border-emerald-500/50 transition-all font-mono"
                 />
              </div>
           </div>
           ...
           <div className="flex items-center gap-4 ml-auto">
              ...
              <div className="flex items-center gap-3 pl-2 cursor-pointer group">
                 <div className="text-right hidden sm:block">
                    <p className="text-[10px] font-black text-white leading-none mb-1 group-hover:text-emerald-500 transition-colors uppercase tracking-tight">{profile?.email?.split('@')[0] || "Admin"}</p>
                    <p className="text-[8px] text-zinc-600 font-bold uppercase tracking-[0.2em] leading-none">Security Level 1</p>
                 </div>
                 <div className="w-10 h-10 rounded-2xl bg-zinc-900 border border-white/10 flex items-center justify-center text-emerald-500 font-black group-hover:border-emerald-500/80 transition-all overflow-hidden bg-[url('https://api.dicebear.com/7.x/shapes/svg?seed=admin')] bg-cover" />
              </div>
           </div>
        </header>

        {/* Content Container */}
        <div className="p-4 md:p-8 pt-10 md:pt-8 pb-32">
