                            ...
                            >
                                {activeTab === 'dashboard' ? (
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-10">
                                        ...
                                        <footer className="pt-10 flex flex-col gap-4 border-t border-white/5">
                                            <div className="p-4 bg-primary/5 border border-primary/20 rounded-2xl flex items-center gap-4">
                                                ...
                                                <p className="text-[10px] font-mono text-dim-text uppercase tracking-widest">
                                                    Pro Tip: Use <a href="https://sanity.io/manage" target="_blank" className="text-primary-glow underline">Sanity Studio</a> for high-level Notes & Tutorials with Rich Text.
                                                </p>
                                            </div>
                                            <div className="flex items-center justify-between">
