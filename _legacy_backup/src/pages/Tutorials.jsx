...
const Tutorials = () => {
    ...
    useEffect(() => {
        const fetchTutorials = async () => {
            try {
                // Fetch Firebase Tutorials
                const firebaseSnapshot = await getDocs(collection(db, 'tutorials'));
                const firebaseTutorials = firebaseSnapshot.docs.map(doc => ({
                    id: doc.id,
                    ...doc.data(),
                    type: 'firebase'
                }));

                // Fetch Sanity Tutorials
                const sanityQuery = `*[_type == "tutorial"]{
                    _id,
                    title,
                    description,
                    category,
                ...
                setTutorials([...formattedSanity, ...firebaseTutorials]);
            } catch (err) {
